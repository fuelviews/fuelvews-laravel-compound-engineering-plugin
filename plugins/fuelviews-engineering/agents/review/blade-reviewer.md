...
- When a finding contradicts current docs for the detected version, downgrade or drop it. When docs confirm the finding, cite the doc reference in the recommendation. Verify Blade directives, Livewire attributes, and Alpine patterns against detected Livewire/Alpine version docs.
